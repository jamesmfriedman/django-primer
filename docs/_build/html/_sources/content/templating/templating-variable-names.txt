...
Modifying a Template Var
-------------------------

If you want to dynamically swap out or override a template, you can do so anywhere you have access to Django's request variable.
